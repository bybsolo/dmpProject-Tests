...
public class Grabber_Test {
	...
	public static void findRoute(int point, Odometer_Test odometer) {
		...
		boolean[] availability = { (T_y != 1 && T_y != Island_LL_y), (T_x != 7 && T_x != Island_UR_x),
				(T_y != 7 && T_y != Island_UR_y), (T_x != 1 && T_x != Island_LL_x) };
